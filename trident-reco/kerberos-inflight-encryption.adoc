...
* *本地 ONTAP* - Trident 支援透過 NFSv3 進行 Kerberos 加密，並支援從 Red Hat OpenShift 和上游 Kubernetes 叢集到本機 ONTAP 磁碟區的連線。
...
* 請確保所有使用 Kerberos 加密的磁碟區都已正確配置。請參閱 https://www.netapp.com/media/16398-tr-3580.pdf["NetApp 增強功能與最佳實務做法指南"^]的 NetApp 網域設定部分（第 13 頁）。
