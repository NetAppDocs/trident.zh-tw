...
NetApp持續改善及強化其產品與服務。以下是Astra Trident的一些最新功能。如需舊版的資訊、請參閱 https://["較早版本的文件"]。
...
* 若要執行iSCSI PV的線上空間回收、工作節點上的基礎作業系統可能需要將掛載選項傳遞至磁碟區。對於需要「disccard」的RHEL/RedHat CoreOS執行個體來說、這是正確的做法 https://["掛載選項"^]；請確定您的隨附了捨棄掛載選項 https://["d4b9b9554fd820f43eae492d33e41167"^] 支援線上區塊捨棄。
