...
是的，Trident 可以離線安裝。請參閱 link:../trident-install/kubernetes-deploy.html["瞭解 Trident 安裝"^]。
...
如有需要，您可以在本機產生和修改 Trident 安裝時使用的確切資訊清單檔案。請參閱 link:trident-install/kubernetes-customize-deploy-tridentctl.html["自訂tridentctl安裝"^]。
