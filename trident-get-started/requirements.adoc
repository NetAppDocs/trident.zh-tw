...
* 在NetApp完全或有限支援下執行ONTAP版本的本機FAS、 AFF或ASA r2（iSCSI、NVMe/TCP 和 FC）。看 link:https://mysupport.netapp.com/site/info/version-support["軟體版本支援"]。
...
NOTE: 此配置在早期版本中有效，但完整認證從 26.06 開始。
...
* docker.io/netapp/trident-operator:26.06.0 （選用）
